...
metronome = Metronome(variant="Metronome", x_cor=60, y_cor=100, wg=150, hg=150, image_7="border-image:url(C-7.png)", sound_7="Sounds/metron_tick.wav", BPM=0.2)
